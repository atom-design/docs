<template>
  <div class="pull-doc">
    <div class="demo-wrapper clearfix">
      <div class="doc-demo">
        <doc-title title="Pull 上下拉动" desc="通过上下拉动来做更新、加载事件"><a class="a-link" href="https://atom-design.github.io/mobile/#/pullGesture/">此测试案例请在移动模式/设备打开</a></doc-title>
      ...
      <mobile routerName="pullGesture"></mobile>
    </div>
    <doc-api :apiList="apiList" desc="使用此组件需通过height属性, 或者在atom-pull标签中设置style/class来设置组件高度，未设置高度则上下拉动不起作用"></doc-api>
  </div>
</template>
...
export default {
  data () {
    return {
      ...
      {
        name: 'action',
        desc: '设置拉动的类型, 可选值pulldown(下拉), pullup(上拉), both(上拉和下拉)',
        type: 'String',
        default: 'both'
      },
      {
      ...
      {
        name: ':delay',
        desc: '设置松开手势时提示停留时间, 单位ms',
        type: 'Number',
        default: '3e2'
      },
      {
        name: 'slot',
        desc: '需要在一级子节点指定拉动提示项的插槽名，否则提示将不起作用, 可选值promptTop (顶部提示项), promptBottom (底部提示项)',
        type: 'String',
        default: '无'
      },
      {
